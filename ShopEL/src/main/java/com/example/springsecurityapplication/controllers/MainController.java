...
//кокнтроллер для всех кто защел на сайт
@Controller
...
//    метод для отображения товаров без авторизации
    @GetMapping("")
    public String getAllAttribute(Model model){
...
//    конвертация из стринг во флот (Float.parseFloat(ot))
@PostMapping("/search")
